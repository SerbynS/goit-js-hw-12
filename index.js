import{a as u,S as f,i as p}from"./assets/vendor-BAz9UMq_.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))l(e);new MutationObserver(e=>{for(const o of e)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&l(a)}).observe(document,{childList:!0,subtree:!0});function s(e){const o={};return e.integrity&&(o.integrity=e.integrity),e.referrerPolicy&&(o.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?o.credentials="include":e.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function l(e){if(e.ep)return;e.ep=!0;const o=s(e);fetch(e.href,o)}})();function h(t){const s=`https://pixabay.com/api/?key=22291580-fa60bbd7949edc60de7cbcd1e&q=${t}&image_type=photo&per_page=119`;return u.get(s).then(l=>l.data.hits).catch(l=>{throw new Error(l)})}function g(t){return t.map(({webformatURL:s,largeImageURL:l,likes:e,views:o,comments:a,downloads:d})=>`
